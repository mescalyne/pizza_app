...
const RemoveItemFromCart = _i1.OperationDefinitionNode(
    type: _i1.OperationType.mutation,
    name: _i1.NameNode(value: 'RemoveItemFromCart'),
    variableDefinitions: [
      _i1.VariableDefinitionNode(
          variable: _i1.VariableNode(name: _i1.NameNode(value: 'cart_item_id')),
      ...
      _i1.FieldNode(
          ...
          arguments: [
            _i1.ArgumentNode(
                ...
                value:
                    _i1.VariableNode(name: _i1.NameNode(value: 'cart_item_id')))
          ],
          directives: [],
          selectionSet: _i1.SelectionSetNode(selections: [
