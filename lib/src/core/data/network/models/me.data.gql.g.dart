...
Serializer<GGetCurrentUserData_me> _$gGetCurrentUserDataMeSerializer =
    new _$GGetCurrentUserData_meSerializer();
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(GGetCurrentUserData_me)));
    }
    return result;
  }
...
class _$GGetCurrentUserData_meSerializer
    implements StructuredSerializer<GGetCurrentUserData_me> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GGetCurrentUserData_me';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GGetCurrentUserData_me object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      '__typename',
      serializers.serialize(object.G__typename,
  ...
  @override
  GGetCurrentUserData_me deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GGetCurrentUserData_meBuilder();
...
class _$GGetCurrentUserData extends GGetCurrentUserData {
  ...
  @override
  final GGetCurrentUserData_me? me;

  factory _$GGetCurrentUserData(
          [void Function(GGetCurrentUserDataBuilder)? updates]) =>
      (new GGetCurrentUserDataBuilder()..update(updates)).build();

  _$GGetCurrentUserData._({required this.G__typename, this.me}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        G__typename, 'GGetCurrentUserData', 'G__typename');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetCurrentUserData')
...
class GGetCurrentUserDataBuilder
  ...
  GGetCurrentUserData_meBuilder? _me;
  GGetCurrentUserData_meBuilder get me =>
      _$this._me ??= new GGetCurrentUserData_meBuilder();
  set me(GGetCurrentUserData_meBuilder? me) => _$this._me = me;
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GGetCurrentUserData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GGetCurrentUserData_me extends GGetCurrentUserData_me {
  @override
  final String G__typename;
  @override
  final String id;
  ...
  factory _$GGetCurrentUserData_me(
          [void Function(GGetCurrentUserData_meBuilder)? updates]) =>
      (new GGetCurrentUserData_meBuilder()..update(updates)).build();

  _$GGetCurrentUserData_me._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        G__typename, 'GGetCurrentUserData_me', 'G__typename');
    BuiltValueNullFieldError.checkNotNull(id, 'GGetCurrentUserData_me', 'id');
    BuiltValueNullFieldError.checkNotNull(
        created_at, 'GGetCurrentUserData_me', 'created_at');
    BuiltValueNullFieldError.checkNotNull(
        updated_at, 'GGetCurrentUserData_me', 'updated_at');
  }

  @override
  GGetCurrentUserData_me rebuild(
          void Function(GGetCurrentUserData_meBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GGetCurrentUserData_meBuilder toBuilder() =>
      new GGetCurrentUserData_meBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GGetCurrentUserData_me &&
        G__typename == other.G__typename &&
        id == other.id &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetCurrentUserData_me')
          ..add('G__typename', G__typename)
          ..add('id', id)
          ..add('name', name)
          ..add('surname', surname)
...
class GGetCurrentUserData_meBuilder
    implements Builder<GGetCurrentUserData_me, GGetCurrentUserData_meBuilder> {
  _$GGetCurrentUserData_me? _$v;
  ...
  GGetCurrentUserData_meBuilder() {
    GGetCurrentUserData_me._initializeBuilder(this);
  }

  GGetCurrentUserData_meBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _G__typename = $v.G__typename;
      _id = $v.id;
  ...
  @override
  void replace(GGetCurrentUserData_me other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GGetCurrentUserData_me;
  }

  @override
  void update(void Function(GGetCurrentUserData_meBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GGetCurrentUserData_me build() {
    _$GGetCurrentUserData_me _$result;
    try {
      _$result = _$v ??
          new _$GGetCurrentUserData_me._(
              G__typename: BuiltValueNullFieldError.checkNotNull(
                  G__typename, 'GGetCurrentUserData_me', 'G__typename'),
              id: BuiltValueNullFieldError.checkNotNull(
                  id, 'GGetCurrentUserData_me', 'id'),
              name: name,
              surname: surname,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GGetCurrentUserData_me', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
