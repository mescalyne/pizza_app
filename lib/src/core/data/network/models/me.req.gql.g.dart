...
class _$GGetCurrentUserReq extends GGetCurrentUserReq {
  ...
  factory _$GGetCurrentUserReq(
      ...
      (new GGetCurrentUserReqBuilder()..update(updates)).build();
  ...
  _$GGetCurrentUserReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GGetCurrentUserReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GGetCurrentUserReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GGetCurrentUserReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetCurrentUserReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GGetCurrentUserReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
